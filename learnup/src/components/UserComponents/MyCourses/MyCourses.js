...
const MyCourses = () => {
  ...
  useEffect(() => {
    ...
    fetch(`/api/v1/auth/countenrolled/${userEmail}`) // Adjust the URL to match your backend route
  ...
  const getCourses = async () => {
    try {
      const res = await axios.get(`/api/v1/auth/enrolled-course/${userEmail}`);
      console.log("Enrolled",res.data.enrolledCourses);
        ...
        <div className='userrowcontainer'>
          <div className='usercolcontainer'>
              <div className='usertopsearch'>
                  <h1 className='maincoursestitle'>My Courses</h1>
    ...
    : addToWishlist(course._id)
          ...
          <div className="usercourse-item-footer">
                            ...
                            R.s {course.courseprice}
                                        ...
                                        <ul>
                        <li>
                            <NavLink to={`/user-dashboard/viewcourse/${course._id}`}
                               className="userdetails-btn" >View Details</NavLink>
                        </li>
                    </ul>
                </div>
        </div>
