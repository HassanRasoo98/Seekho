  ...
  const navigate = useNavigate();
    const handleSearchChange = (e) => {
      ...
      useEffect(() => {
        ...
        axios.get('/api/v1/save/getcoursesfromwhishlist', {
          params: {
      ...
      useEffect(() => {
        ...
        axios.get('/api/v1/save/countwhishlist', {
          params: {
            userEmail: auth?.user?.email, // Replace with the actual user's email
          },
        })
                  ...
                  <div className='usersearchinput'>
                    <form className='usersearchform'>
                        <div className='userform-group'>
                            <input type='text' name='search' placeholder='Search Wishlist Courses' className='userform-groupsearch' value={searchQuery}
  ...
  {filteredCourses.map((course)=>(
        <div className="usercourse-item" key={course._id}>
            ...
            <div className="usercourse-item-body">
                <div className="usercourse-item-body-inner">
                    <div className="usercourse-item-header">
                        ...
                        <li>
                                <NavLink to="/user-dashboard/whishlist" className='usercourseLabel'>{course.coursecategory}<FaHeart className={`subwhishlisticon ${
                                        Array.isArray(userWishlist) && userWishlist.includes(course._id) ? 'whishlisticon-active' : ''
                                            }`} onClick={() =>removeFromWishlist(course._id)}/></NavLink>
                            </li>
          ...
          <div className="usercourse-item-footer">
                        ...
                        <li>
                            <a href="/"
                               className="userdetails-btn">Add to Card</a>
                        </li>
                    </ul>
                </div>
            </div>
