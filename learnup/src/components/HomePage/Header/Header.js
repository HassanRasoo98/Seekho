      ...
      <div className='header-navigation'>
        <div className='container container-1278'>
          <div className='header-inner'>
            ...
            <a href='/'><div className='website-name'> Seekho</div></a>

              <div className='course-active'>
                <a href='/'>Courses <FaArrowDown className='down-arrow'/></a>
            ...
            <nav className='nav-menu'>
              <ul>
                <li><a href='/'>Home</a></li>
                  ...
                  <li onClick={scrollToCoursePage}><a>Courses</a></li>
                <li onClick={scrollToPageDetails}><a>Contact Us</a></li>
                <li><div className='login-active'>
                <NavLink to='/login'>Log In< FaUser className='down-arrow'/></NavLink></div></li>
              </ul>
            </nav>
          </div>
        </div>
