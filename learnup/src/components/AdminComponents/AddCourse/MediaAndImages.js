  ...
  return <>
    ...
    <div className='addmediacontainer'>
        ...
        <form className='imagemediaforms'>
            ...
            {courseData.courseimg && <img src={URL.createObjectURL(courseData.courseimg)} alt="Selected" className="preview-image" />}
            </div>
            <div className='videocontainer'>
            <input type="file" id="video" accept="video/*" multiple onChange={handleVideoUpload} />
           ...
           <div className='addmediaimagesbtncontainer'>
                    <button type="submit"className='addimagesnextbtn' onClick={handleNextImagesbtn}>Create Course</button>
                    <ToastContainer />
                </div>
        </form>
    </div>
